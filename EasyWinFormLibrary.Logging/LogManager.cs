...
namespace EasyWinFormLibrary
{
    ...
    {
        private class SerilogAdapter : IEasyLibraryLogger
        {
            public void Error(System.Exception ex, string message) => Logger.Error(ex, message);
        }
        ...
        public static void InitLogger(string sentryDsn)
        {
            ...
            // Route the core library's internal error logging (e.g. SqlDatabaseActions)
            // through this Serilog/Sentry logger.
            EasyLog.Logger = new SerilogAdapter();
        }
    }
}